...
void initVariant() { uint8_t mac[6] = {0xa6, 0x97, 0x02, 0xfb, 0x0b, 0x40}; wifi_set_macaddr(STATION_IF, &mac[0]); }
...
void setup() {
    ...
    {
      delay(10000);
      Serial.print("Delay by Controller");
      EEPROM.write(1,0);
      EEPROM.commit();
    }
